...
_SYNCRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='val', full_name='syncResponse.val', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='key', full_name='syncResponse.key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='cmd', full_name='syncResponse.cmd', index=2,
...
try:
  ...
  class ReplicatorStub(object):
    ...
    def __init__(self, channel):
      ...
      self.sync = channel.unary_stream(
          ...
          response_deserializer=syncResponse.FromString,
          )
  ...
  def add_ReplicatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'sync': grpc.unary_stream_rpc_method_handler(
            ...
            response_serializer=syncResponse.SerializeToString,
        ),
  ...
  def beta_create_Replicator_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    response_serializers = {
      ...
      ('Replicator', 'sync'): syncResponse.SerializeToString,
    }
  ...
  def beta_create_Replicator_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    response_deserializers = {
      ...
      ('Replicator', 'sync'): syncResponse.FromString,
    }
    cardinalities = {
