...
class ReplicatorStub(object):
  ...
  def __init__(self, channel):
    ...
    self.sync = channel.unary_stream(
        '/Replicator/sync',
        request_serializer=replicator__pb2.syncRequest.SerializeToString,
        response_deserializer=replicator__pb2.syncResponse.FromString,
        )
...
def add_ReplicatorServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'sync': grpc.unary_stream_rpc_method_handler(
          servicer.sync,
          request_deserializer=replicator__pb2.syncRequest.FromString,
          response_serializer=replicator__pb2.syncResponse.SerializeToString,
      ),
