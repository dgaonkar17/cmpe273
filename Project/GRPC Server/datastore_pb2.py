...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='',
  syntax='proto3',
  serialized_pb=_b('\n\x0f\x64\x61tastore.proto\"\xa8\x01\n\x07Request\x12\x11\n\tbookingid\x18\x01 \x01(\t\x12\x10\n\x08username\x18\x02 \x01(\t\x12\x0f\n\x07phoneno\x18\x03 \x01(\t\x12\x13\n\x0b\x63heckindate\x18\x04 \x01(\t\x12\x10\n\x08noofdays\x18\x05 \x01(\t\x12\x10\n\x08roomtype\x18\x06 \x01(\t\x12\r\n\x05price\x18\x07 \x01(\t\x12\x0e\n\x06roomno\x18\x08 \x01(\t\x12\x0f\n\x07oprtype\x18\t \x01(\t\"\x18\n\x08Response\x12\x0c\n\x04\x64\x61ta\x18\x01 \x01(\t2G\n\tDatastore\x12\x1c\n\x03put\x12\x08.Request\x1a\t.Response\"\x00\x12\x1c\n\x03get\x12\x08.Request\x1a\t.Response\"\x00\x62\x06proto3')
)
...
_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='bookingid', full_name='Request.bookingid', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='username', full_name='Request.username', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='phoneno', full_name='Request.phoneno', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='checkindate', full_name='Request.checkindate', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='noofdays', full_name='Request.noofdays', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='roomtype', full_name='Request.roomtype', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='price', full_name='Request.price', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='roomno', full_name='Request.roomno', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='oprtype', full_name='Request.oprtype', index=8,
