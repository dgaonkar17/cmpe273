...
class yelp_handle:
    ...
    CLIENT_ID = 'HfpnMlPuM5q7SvxHLUQxXg'
    CLIENT_SECRET ='HT5dKAczwfWvspOrmcQ4MpiMiBY0f1r3IBkDuKKXLMl1I2tdYDT903tv6fJtODHz'
    ...
    """
        ...
        return self.request(self.API_HOST, business_path, bearer_token)
    ...
    def test_yelp(self,category,city):
        print("insideee yelp"+category +"city"+city)
        ...
        try:
            myval=self.query_api(input_values.term, input_values.location)
            print(myval)
            name=myval['name']
            display_phone = myval['phone']
            url=myval['url']
